...
import SellerOrderStatusSelect from "./SellerOrderStatusSelect";
import SellerPaymentStatusSelect from "./SellerPaymentStatusSelect";
...
const SellerOrderRow = ({ order }: AdminOrderRowProps) => {
  ...
  return (
    <tr className="border-b border-gray-100 last:border-b-0 hover:bg-gray-50">
      ...
      <td className="px-5 py-4">
        <SellerOrderStatusSelect order={order} />
      </td>
      ...
      <td className="px-5 py-4">
        {payment ? (
          <SellerPaymentStatusSelect payment={payment} />
        ) : (
