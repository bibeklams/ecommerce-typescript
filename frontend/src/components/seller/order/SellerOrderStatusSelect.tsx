...
import { updateSellerOrderStatusThunk } from "../../../redux/slices/orderSlice";
...
const SellerOrderStatusSelect = ({ order }: OrderStatusSelectProps) => {
...
export default SellerOrderStatusSelect;
