...
import { getSellerOrderByIdThunk } from "../../../redux/slices/orderSlice";
import SellerOrderStatusSelect from "../../../components/seller/order/SellerOrderStatusSelect";
...
const SellerOrderDetailsPage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getSellerOrderByIdThunk(Number(orderId)));
  }, [dispatch, orderId]);
